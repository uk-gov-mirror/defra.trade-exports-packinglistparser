...
import { matches as matchesNutricia3 } from './matchers/nutricia/model3.js'
import { parse as parseNutricia3 } from './parsers/nutricia/model3.js'
...
const parsersExcel = {
  ...
  NUTRICIA3: {
    matches: matchesNutricia3,
    parse: parseNutricia3
  },
  SAINSBURYS1: {
