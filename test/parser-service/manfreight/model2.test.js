...
import model from '../../test-data-and-results/models/manfreight/model2.js'
import test_results from '../../test-data-and-results/results/manfreight/model2.js'
...
const filename = 'packinglist-manfreight-model2.xlsx'

describe('matchesManfreightModel2', () => {
  test('matches valid Manfreight Model 2 file, calls parser and returns all_required_fields_present as true', async () => {
  ...
  test('matches valid Manfreight Model 2 file, calls parser, but returns all_required_fields_present as false when cells missing', async () => {
    const result = await parserService.parsePackingList(
  ...
  test('matches valid Manfreight Model 2 file, calls parser and returns all_required_fields_present as false for multiple rms', async () => {
    const result = await parserService.parsePackingList(
      model.multipleRms,
      filename
    )
  ...
  test('matches valid Manfreight Model 2 file, calls parser and returns all_required_fields_present as false for missing kg unit', async () => {
    const result = await parserService.parsePackingList(
      model.missingKgunit,
      filename
    )
...
describe('Manfreight2 NIRMS Validation Tests', () => {
