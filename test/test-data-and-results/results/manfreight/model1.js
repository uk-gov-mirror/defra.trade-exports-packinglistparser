...
export default {
  validTestResult: {
    ...
    registration_approval_number: 'RMS-GB-000013-001',
    parserModel: parserModel.MANFREIGHT1
  },
  ...
  missingKgunit: {
    ...
    establishment_numbers: ['RMS-GB-000013-001'],
    registration_approval_number: 'RMS-GB-000013-001',
    parserModel: parserModel.MANFREIGHT1
  },
  multipleRms: {
    ...
    establishment_numbers: ['RMS-GB-000013-001', 'RMS-GB-000013-002'],
    registration_approval_number: 'RMS-GB-000013-001',
    parserModel: parserModel.MANFREIGHT1
  }
}
